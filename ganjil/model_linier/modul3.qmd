...
image: https://raw.githubusercontent.com/aslab-math-ui/asset/main/model_linier/static/bg_modul1.jpg
...
```{r}
datareg <- read.csv("https://raw.githubusercontent.com/aslab-math-ui/asset/main/model_linier/datasets/datareg.csv")
head(datareg)
```
...
```{r}
nilai_UTS <- read.csv("https://raw.githubusercontent.com/aslab-math-ui/asset/main/model_linier/datasets/nilai_UTS.csv")
head(nilai_UTS)
str(nilai_UTS)
